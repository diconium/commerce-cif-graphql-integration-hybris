...
describe('Create Customer Resolver', function() {
  ...
  describe('Integration Tests', () => {
    ...
    it('Mutation: create customer response should always contain object', () => {
      args.query =
        'mutation {createCustomer(input: {firstname: "Amaresh1", lastname: "muni", email: "test@example.com", password: "Test@1234", is_subscribed: true}) {customer {firstname,lastname,email,is_subscribed}}}';
